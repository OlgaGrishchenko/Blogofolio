      ...
      >
         ...
         <div className={styles.cardFooter}>
            ...
            <div className={styles.iconsContainer}>
               <div className={styles.iconButton}><LikeIcon /></div>
               <div className={styles.iconButton}><DislikeIcon /></div>
            </div>

            <div className={styles.iconsContainer}>
               <div className={styles.iconButton}><BookmarkIcon /></div>
               <div className={styles.iconButton}><MoreIcon /></div>
            </div>
